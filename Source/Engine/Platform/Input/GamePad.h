...
public:
	...
	static const GamePadButton BTN_ESC = (1 << 17);
	static const GamePadButton BTN_Q = (1 << 18);
	static const GamePadButton BTN_E = (1 << 19);
...
public:
    ...
    // 押した瞬間判定
    bool IsTriggered(GamePadButton button) const { 
	...
	void ForceBottonUp(GamePadButton btn);
