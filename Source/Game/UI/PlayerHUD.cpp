...
void PlayerHUD::Initialize(UIManager* uiManager)
{
    ...
    std::string BerFrameFilePath = "/Assets/UI/HUD/PlayerBord.png";
    std::string HPBerFilePath = "/Assets/UI/HUD/HealhtBar.png";
    std::string StaminaBerFilePath = "/Assets/UI/HUD/Stamina.png";
